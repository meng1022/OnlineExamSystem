    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="场次">
          <a-input placeholder="请输入场次" v-decorator="['sessionCode', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="场次名称">
          <a-input placeholder="请输入场次名称" v-decorator="['sessionName', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="考试时长">
          <a-input-number v-decorator="[ 'examDuration', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="提交次数（0为不限制）">
          <a-input-number v-decorator="[ 'submitTimes', {}]" />
        </a-form-item>
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
		  ...
		  //时间格式化
          this.form.setFieldsValue({status:this.model.status === 1?"1":"2"})
