...
<!--        <a-col :md="6" :sm="8">-->
<!--            <a-form-item label="可见开始时间">-->
<!--              <a-input placeholder="请输入可见开始时间" v-model="queryParam.visiableStartTime"></a-input>-->
<!--            </a-form-item>-->
<!--          </a-col>-->
<!--          <a-col :md="6" :sm="8">-->
<!--            <a-form-item label="可见结束时间">-->
<!--              <a-input placeholder="请输入可见结束时间" v-model="queryParam.visiableEndTime"></a-input>-->
<!--            </a-form-item>-->
<!--          </a-col>-->
<!--          <a-col :md="6" :sm="8">-->
<!--            <a-form-item label="考试开始时间">-->
<!--              <a-input placeholder="请输入考试开始时间" v-model="queryParam.examStartTime"></a-input>-->
<!--            </a-form-item>-->
<!--          </a-col>-->
<!--        </template>-->
...
<!--      </div>-->
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)">考试信息</a>
...
<script>
  ...
  computed: {
    ...
    methods: {
     handleQuestion: function(examId){
        this.$router.push({ name: 'exammanage-question', params: {examid:examId} })
