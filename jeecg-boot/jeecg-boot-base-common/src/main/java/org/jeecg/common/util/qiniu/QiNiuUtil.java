...
public class QiNiuUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "gGk3ftIb0Wy0nRP8-fDsTSVqOZNSTSF2TNN0IJjW";
    private static final String SECRET_KEY = "9FoDz1i1eawnIAnXByWGQUOXJW0r8mbWRF5OVpD2";

    // 要上传的空间
    private static final String bucketname = "hkangcloud_pub";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "http://qiniu.hkangcloud.com/";
